								...
								<div class="card-body">
									<table class="table table-responsive-md table-striped mb-0">
                                        ...
                                        <?php
											...
											// NEW QUERY - Updated for new table structure
											$abs_res = mysqli_query($conn, "SELECT * FROM registrations ORDER BY id DESC;");
											$sno = 1;
          									while ($row = mysqli_fetch_array($abs_res)) {
												...
												// OLD PARTICIPANT INFO - COMMENTED OUT
												/*
												...
												*/
												...
												// NEW PARTICIPANT INFO - Updated fields
												echo "<td style='word-break: break-all;'>
														<i class='fa fa-user'></i> <a> <b>" . htmlspecialchars($row['name']) . "</b></a><br>
														<i class='fa fa-phone'></i> " . htmlspecialchars($row['mobile']) . "<br>
														<i class='fa fa-envelope'></i> " . htmlspecialchars($row['email']) . "<br>
														<i class='fa fa-university'></i> " . htmlspecialchars($row['affiliation']) . "<br>
														<i class='fa fa-calendar'></i> Reg. Timestamp: " . htmlspecialchars($row['created_at']) . "
													  </td>";
												
												 // NEW REGISTRATION DETAILS - Updated fields
												echo "<td>
														<b>PAYMENT INFO</b><br>
														<i class='fa fa-barcode'></i> Transaction ID: " . htmlspecialchars($row['transaction_id']) . "<br>
														<i class='fa fa-print'></i> <a href='" . htmlspecialchars($row['payment_receipt']) . "' target='_new'>Download Receipt</a><br>
													  </td>";
												
												// OLD DOWNLOADS - COMMENTED OUT
												/*
												echo "<td>
												...
												*/
												...
												// NEW DOWNLOADS - Updated path
												echo "<td>
														<p align='justify'><a href='" . htmlspecialchars($row['abstract']) . "' class='btn btn-primary' target='_new'>Download Abstract</a></p>
													  </td>";
